...
/* Questão 01 */
export const resposta01 = 14 / 2 > 3 (true)

/* Questão 02 */
export const resposta02 = "Abacate" === "Abacate" (true)

/* Questão 03 */
export const resposta03 = 123 == "123" (true)

/* Questão 04 */
export const resposta04 = 70 < 80 (true)

/* Questão 05 */
export const resposta05 = null === null (true)

/* Questão 06 */
export const resposta06 = 456 !== undefined

/* Questão 07 */
export const resposta07 = false && true || true (true)

/* Questão 08 */
export const resposta08 = 20 === 20 (true)

/* Questão 09 */
export const resposta09 = "fido" < "snoopy" (true)

/* Questão 10 */
export const resposta10 = false || true (true)
